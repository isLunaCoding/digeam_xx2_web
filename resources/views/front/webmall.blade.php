...
<head>
    ...
    <link rel="stylesheet" href="/css/event/webmall/style.css?v2.1">
</head>
        ...
        <div class="main">
            ...
            <div class="popS" v-if="popS == true">
                <div class="isInfo" v-if="isInfo == true">
                    <div class="up">
                        ...
                        <p class="itemInfo">%[pop_info.info]</p>
                    </div>
            ...
            <div class="popB" v-if="popB == true">
                ...
                <ul>
                    ...
                    <li>於購物倉庫領取商品，每次領取的最大數量為10個，若持有道具數量低於10個，點擊領取時將依照持有數量一次發送。</li>
                    ...
                    <li>部分商品有購買、不可交易等條件限制，消費前請詳閱商品說明。</li>
                    <li>部分商品為機會中獎商品，消費者購買或參與活動不代表即可獲得特定商品。</li>
                    <li>購買前請務必確認消費帳號內已有角色，若因未創建角色致該帳號無法正常取得商品，不予以補還點數或商品或其他等值商品。</li>
