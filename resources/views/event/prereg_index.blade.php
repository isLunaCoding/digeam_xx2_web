...
<head>
    ...
    <link rel="stylesheet" href="css/event/prereg/main.css?v1.4">
    <link rel="stylesheet" href="css/event/prereg/style1440.css?v1.4">
    <link rel="stylesheet" href="css/event/prereg/style820.css?v1.4">
    <link rel="stylesheet" href="css/event/prereg/style425.css?v1.4">
    <link rel="stylesheet" href="css/event/prereg/style375.css?v1.4">
    <link rel="stylesheet" href="css/event/prereg/animate.css?v1.4">
...
<body>
    ...
    <script src="js/event/prereg/api.js?v1.5" type="text/javascript"></script>
</body>
<script>
