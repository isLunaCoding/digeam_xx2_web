...
<body>
    ...
    <script src="js/event/prereg/main.js?v1.72" type="text/javascript"></script>
    <script src="js/event/prereg/text.js?v1.72" type="text/javascript"></script>
    <script src="js/event/prereg/rain.js?v1.72" type="text/javascript"></script>
    <script src="js/event/prereg/api.js?v1.72" type="text/javascript"></script>
</body>
<script>
