...
<body>
    ...
    <script src="js/event/prereg/main.js?v2.03" type="text/javascript"></script>
    <script src="js/event/prereg/text.js?v2.03" type="text/javascript"></script>
    <script src="js/event/prereg/api.js?v2.03" type="text/javascript"></script>
    <script src="js/event/prereg/menu.js?v2.03" type="text/javascript"></script>
</body>
<script>
