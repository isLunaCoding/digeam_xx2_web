...
function pop() {
    $('.pop').on("click", function () {
        ...
        } else if (popId == 'content_sec1') {
            $(".pop_b_box").html(close + content.title.props + content.img.sec01);
        } else if (popId == 'content_sec2_1') {
            $(".pop_b_box").html(close + content.title.props + content.img.sec02_1);
        ...
        } else if (popId == 'sec5_img_1') {
            $(".pop_b_box").html(close + content.title.fashion + content.img.sec05_1);
        } else if (popId == 'sec5_img_2') {
            $(".pop_b_box").html(close + content.title.fashion + content.img.sec05_2);
        }else if (popId == 'sec5_img_3') {
            $(".pop_b_box").html(close + content.title.fashion + content.img.sec05_3);
        }else if (popId == 'sec5_img_4') {
            $(".pop_b_box").html(close + content.title.fashion + content.img.sec05_4);
        }
