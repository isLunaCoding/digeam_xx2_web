let notice = {
    ...
    <ul>
        <li>1.活動期間內，於遊戲中達成指定任務後可獲得對應數量的天龍紀念幣，詳細任務內容可於遊戲內確認。</li>
        <li>2.活動任務限定每天僅可完成一次，每日重置。</li>
        <li>3.天龍紀念幣可用於活動兌換商店兌換各種實用道具。</li>
        <li>4.兌換商店內的部分道具有兌換次數限制，詳細內容可於遊戲內確認。</li>
        <li>5.活動獎項可能有交易、販售、使用次數或使用時間等限制，實際道具限制依遊戲內為準。</li>
        <li>6.若因觸犯遊戲規章遭受凍結處分、個人線路不穩、個人操作不慎等，導致斷線、連線失敗等問題影響活動參與，活動將照常舉行，不另做補償。</li>
        <li>7.本活動各項辦法及規定，以活動網站公告及本公司官方最新說明為準。掘夢網股份有限公司擁有活動最終保留、變更、修正或撤回、取消獎項發送之權利，若因不可抗力之因素，本活動將有權隨時補充或修正，並以最新公告為主。</li>
    </ul>
    </div>`,
