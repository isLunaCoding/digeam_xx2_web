...
class launcherController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->model()->where('type', 'launcher')->orderBy('status', 'desc')->orderBy('sort', 'asc');
